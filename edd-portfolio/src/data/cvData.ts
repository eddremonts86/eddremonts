...
export const experiences = [
  {
    ...
    location: 'Copenhagen (Denmark)',
    description:
      'Leading frontend development for Schilling web applications and data products, working with React 18/19, TypeScript, Node.js, Tailwind and Shadcn UI to scale complex real-estate workflows.',
  },
  {
    id: 11,
    ...
    location: 'Copenhagen (Denmark)',
    description:
      'Leading frontend development for Resights web applications and data products, working with Vue 2/3, Nuxt 2/3, TypeScript, Pinia/Vuex, Node.js, and Vuetify to scale complex real-estate workflows.',
  },
  {
    id: 10,
    ...
    location: 'Copenhagen (Denmark)',
    description:
      'Built internal health and administration tools for Novo Nordisk with Vue, Vuetify, HTML, and CSS, focusing on reliable UI foundations for regulated medical teams.',
  },
  {
    id: 9,
    ...
    location: 'Copenhagen (Denmark)',
    description:
      'Delivered accessible campaign and landing experiences for Wunderman Nordic using Vue, SCSS, Bootstrap, and C# integrations, supporting high-traffic launches with stable frontend architecture.',
  },
  {
    id: 8,
    ...
    location: 'Copenhagen (Denmark)',
    description:
      'Led frontend development at GiG Media Copenhagen across affiliate and content platforms, modernizing legacy estates built on Laravel, Drupal, October CMS, MySQL, jQuery, Bootstrap, and PHP while coordinating outsourced maintenance work.',
  },
  {
    id: 7,
    ...
    location: 'Copenhagen (Denmark)',
    description:
      'Worked on high-conversion affiliate products at Rebel Penguins, shipping frontend improvements, experiments, and UI iterations across Drupal, Laravel, October CMS, Bootstrap, and MySQL-backed platforms.',
  },
  {
    id: 6,
    ...
    location: 'Copenhagen (Denmark)',
    description:
      'Developed internal dashboards and external client sites end to end at Rebel Penguins using PHP, MySQL, jQuery, Bootstrap, Drupal, October CMS, and Laravel.',
  },
  {
    id: 5,
    ...
    location: 'Copenhagen (Denmark)',
    description:
      "Supported Plan Denmark's sponsorship department by registering and validating documents, helping keep administrative workflows clean, structured, and reliable.",
  },
  {
    id: 4,
    ...
    description:
      'Founded Viruta Studio Creativo and built custom products for local organizations and media outlets, including sites such as Radio Guama, using PHP, MySQL, PostgreSQL, Joomla, Drupal, Bootstrap, and Ext JS.',
  },
  {
    id: 3,
    ...
    location: 'Pinar del Rio (Cuba)',
    description:
      "Built internal systems at GEOCUBA's R&D agency, combining PHP, MySQL, PostgreSQL, Ext JS, jQuery, Bootstrap, and geospatial tooling for operational and information-management needs.",
  },
  {
    id: 2,
    ...
    location: 'Pinar del Rio (Cuba)',
    description:
      'Developed statistical and administrative solutions for the Provincial Office of ONEI using PHP, MySQL, HTML, CSS, Ext JS, Drupal, and Joomla.',
  },
  {
    id: 1,
    ...
    description:
      'Started my professional career on the National Library project at UCI, building Drupal, PHP, and MySQL solutions while coordinating junior developers as the team matured.',
  },
];
