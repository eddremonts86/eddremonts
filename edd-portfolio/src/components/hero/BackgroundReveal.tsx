...
export const BackgroundReveal = ({ src }: { src: string }) => (
  ...
  >
    <div className="absolute inset-0 z-10 bg-black/20 transition-opacity duration-1000" />
    ...
    <img
      ...
      className="h-full w-full object-cover object-[center_15%] contrast-125 grayscale"
    />
  </m.div>
);
