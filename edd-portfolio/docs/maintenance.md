...
- **Adding an Experience:** Insert a new object at the _top_ of the `experiences` array to keep reverse-chronological order. The `ExperienceTimeline` component will inherently auto-generate the neon timeline dots.
